...
public class AddBoardInfo {
	...
	public String toString() {
		return "AddBoardInfo [PP_ID=" + PP_ID + ", PPE_Type=" + PPE_Type
				+ ", PPE_Height=" + PPE_Height + ", PPE_Width=" + PPE_Width
				+ ", PPE_Index=" + PPE_Index + ", PPE_Image=" + PPE_Image
				+ ", PPE_ImageBorder=" + PPE_ImageBorder + ", PPE_Href="
				+ PPE_Href + ", PPE_FontSize=" + PPE_FontSize
				+ ", PPE_FontFamily=" + PPE_FontFamily + ", PPE_FontText="
				+ PPE_FontText + ", PPE_FontColor=" + PPE_FontColor
				+ ", PPE_FontBackColor=" + PPE_FontBackColor + ", PPE_InWay="
				+ PPE_InWay + ", PPE_InDirection=" + PPE_InDirection
				+ ", PPE_Margin=" + PPE_Margin + ", PPE_PointCenter="
				+ PPE_PointCenter + ", PPE_PointLeftUp=" + PPE_PointLeftUp
				+ ", PPE_PointRightUp=" + PPE_PointRightUp
