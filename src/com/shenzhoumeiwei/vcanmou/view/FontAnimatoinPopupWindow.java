...
public class FontAnimatoinPopupWindow extends PopupWindow implements OnClickListener,OnItemClickListener {
	...
	public FontAnimatoinPopupWindow(Context context, View popupView) {
	...
	private void findView(){
		mGridView = (GridView) mRootView.findViewById(R.id.font_animation_grid);
