...
public class SingleTouchView extends View {
	...
	public static final int DEFAULT_FRAME_COLOR = Color.GREEN;
	...
	private void computeRect(int left, int top, int right, int bottom,
		...
		mLTPoint = obtainRoationPoint(cp, lt, 0);//degree
		mRTPoint = obtainRoationPoint(cp, rt, 0);
		mRBPoint = obtainRoationPoint(cp, rb, 0);
		mLBPoint = obtainRoationPoint(cp, lb, 0);
