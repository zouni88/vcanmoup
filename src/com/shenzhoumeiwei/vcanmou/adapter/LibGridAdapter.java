...
public class LibGridAdapter extends BaseAdapter {
    ...
    private static final String TAG = "LibGridAdapter";

    private List mList; // 桌台类型
    private LayoutInflater mInflater;
    private Resources mResources;

    public LibGridAdapter(Context context, List list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.lib_grid_item, parent, false);
