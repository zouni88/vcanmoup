...
public class DraggableGridView_h extends ViewGroup implements View.OnTouchListener, View.OnClickListener, View.OnLongClickListener {
	//layout vars
...
//    private int mScroll = 0;
    ...
    public DraggableGridView_h (Context context, AttributeSet attrs) {
        super(context, attrs);
        setListeners();
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		Log.e("Measure", "width:" + measureWidth + "|height:" + measureHeight);
...
/*    public int getIndexFromCoor(int x, int y)
    ...
    public int getIndexFromCoor(int x, int y)
    {
        ...
        if (col == -1) //touch is between columns or rows
            return -1;
        int index = col;
        if (index >= getChildCount())
            return -1;
...
//            	   lastDeltaX = 0;
    ...
    public void scrollToRight() {
    	mScrollX = -(getChildCount() * (childSize + padding));
    }
